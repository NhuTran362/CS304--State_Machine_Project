...
int main(int argc, char * argv[]) {
	...
	//TASK 39
		...
		test_NFA_11_00_1_DFA();
		test_NFA_11_00_2_DFA();
		test_NFA_11_00_3_DFA();
		test_NFA_11_00_4_DFA();
		test_NFA_11_00_5_DFA();
		test_NFA_11_00_6_DFA();
		test_NFA_11_00_7_DFA();
		test_NFA_11_00_8_DFA();
		test_NFA_11_00_9_DFA();
		test_NFA_11_00_10_DFA();
		test_NFA_11_00_11_DFA();
		test_NFA_11_00_12_DFA();

		//test for NFA_end_01 to DFA
		test_NFA_end_01_1_DFA();
		test_NFA_end_01_2_DFA();
		test_NFA_end_01_3_DFA();
		test_NFA_end_01_4_DFA();
		test_NFA_end_01_5_DFA();
		test_NFA_end_01_6_DFA();
		test_NFA_end_01_7_DFA();
		test_NFA_end_01_8_DFA();
		test_NFA_end_01_9_DFA();
		test_NFA_end_01_10_DFA();
		test_NFA_end_01_11_DFA();
		test_NFA_end_01_12_DFA();

		//test for NFA_third_0 to DFA
		test_NFA_third_0_1_DFA();
		test_NFA_third_0_2_DFA();
		test_NFA_third_0_3_DFA();
		test_NFA_third_0_4_DFA();
		test_NFA_third_0_5_DFA();
		test_NFA_third_0_6_DFA();
		test_NFA_third_0_7_DFA();
		test_NFA_third_0_8_DFA();
		test_NFA_third_0_9_DFA();
		test_NFA_third_0_10_DFA();
		test_NFA_third_0_11_DFA();
		test_NFA_third_0_12_DFA();

		//test for NFA_substring_1110 to DFA
		 test_NFA_substring_1110_1_DFA();
		 test_NFA_substring_1110_2_DFA();
		 test_NFA_substring_1110_3_DFA();
		 test_NFA_substring_1110_4_DFA();
		 test_NFA_substring_1110_5_DFA();
		 test_NFA_substring_1110_6_DFA();
		 test_NFA_substring_1110_7_DFA();
		 test_NFA_substring_1110_8_DFA();
		 test_NFA_substring_1110_9_DFA();
		 test_NFA_substring_1110_10_DFA();
		 test_NFA_substring_1110_11_DFA();
		 test_NFA_substring_1110_12_DFA();
		...
		//test for NFA_empty_string to DFA
		 test_NFA_empty_string_1_DFA();
		 test_NFA_empty_string_2_DFA();
		 test_NFA_empty_string_3_DFA();
		 test_NFA_empty_string_4_DFA();
		 test_NFA_empty_string_5_DFA();
		 test_NFA_empty_string_6_DFA();
		 test_NFA_empty_string_7_DFA();
		 test_NFA_empty_string_8_DFA();
		 test_NFA_empty_string_9_DFA();
		 test_NFA_empty_string_10_DFA();
		 test_NFA_empty_string_11_DFA();
		 test_NFA_empty_string_12_DFA();

		//test for NFA_nonempty_string to DFA
		 test_NFA_nonempty_string_1_DFA();
		 test_NFA_nonempty_string_2_DFA();
		 test_NFA_nonempty_string_3_DFA();
		 test_NFA_nonempty_string_4_DFA();
		 test_NFA_nonempty_string_5_DFA();
		 test_NFA_nonempty_string_6_DFA();
		 test_NFA_nonempty_string_7_DFA();
		 test_NFA_nonempty_string_8_DFA();
		 test_NFA_nonempty_string_9_DFA();
		 test_NFA_nonempty_string_10_DFA();
		 test_NFA_nonempty_string_11_DFA();
		 test_NFA_nonempty_string_12_DFA();
		...
		//test for NFA_non_empty_even_len to DFA
		 test_NFA_non_empty_even_len_1_DFA();
		 test_NFA_non_empty_even_len_2_DFA();
		 test_NFA_non_empty_even_len_3_DFA();
		 test_NFA_non_empty_even_len_4_DFA();
		 test_NFA_non_empty_even_len_5_DFA();
		 test_NFA_non_empty_even_len_6_DFA();
		 test_NFA_non_empty_even_len_7_DFA();
		 test_NFA_non_empty_even_len_8_DFA();
		 test_NFA_non_empty_even_len_9_DFA();
		 test_NFA_non_empty_even_len_10_DFA();
		 test_NFA_non_empty_even_len_11_DFA();
		 test_NFA_non_empty_even_len_12_DFA();
		...
		//test for NFA_0s_or_01s
		 test_NFA_0s_or_01s_1_DFA();
		 test_NFA_0s_or_01s_2_DFA();
		 test_NFA_0s_or_01s_3_DFA();
		 test_NFA_0s_or_01s_4_DFA();
		 test_NFA_0s_or_01s_5_DFA();
		 test_NFA_0s_or_01s_6_DFA();
		 test_NFA_0s_or_01s_7_DFA();
		 test_NFA_0s_or_01s_8_DFA();
		 test_NFA_0s_or_01s_9_DFA();
		 test_NFA_0s_or_01s_10_DFA();
		 test_NFA_0s_or_01s_11_DFA();
		 test_NFA_0s_or_01s_12_DFA();

		//test for NFA_1s_or_end_0 to DFA
		 test_NFA_1s_or_end_0_1_DFA();
		 test_NFA_1s_or_end_0_2_DFA();
		 test_NFA_1s_or_end_0_3_DFA();
		 test_NFA_1s_or_end_0_4_DFA();
		 test_NFA_1s_or_end_0_5_DFA();
		 test_NFA_1s_or_end_0_6_DFA();
		 test_NFA_1s_or_end_0_7_DFA();
		 test_NFA_1s_or_end_0_8_DFA();
		 test_NFA_1s_or_end_0_9_DFA();
