...
// rejected
const list<string> NFA_11_00_t7 = { "0 1111001","3 111001","2 11001", "1 1001", "1 001", "empty" };
const list<string> NFA_11_00_t8 = { "0 1111001","2 111001","2 11001", "2 1001", "3 001", "4 01", "4 1", "4 EPSILON" };
const list<string> NFA_11_00_t9 = { "0 1111001","1 111001","1 11001", "empty" };
...
const list<string> NFA_11_00_t12= { "0 1100", "0 100","2 00", "empty"};
...
//rejected
const list<string> NFA_END_01_t7 = { "0 100101", "0 00101", "0 0101", "2 101", "2 01", "empty" };
...
//rejected
const list<string> NFA_third_0_t7 = { "0 1000101","0 000101", "0 00101", "0 0101","1 101","1 01","3 1", "empty" };
...
const list<string> NFA_substring_1110_t8 = { "0 010111010", "4 10111010", "0 0111010", "0 111010", "0 11010", "1 1010", "2 010","empty" };
const list<string> NFA_substring_1110_t9 = { "0 010111010", "0 10111010", "0 0111010", "0 111010", "4 11010", "0 1010", "1 010","empty" };
const list<string> NFA_substring_1110_t10 = { "0 010111010", "0 10111010", "0 0111010", "0 111010", "0 11010", "0 1010", "0 010","0 10", "2 0","empty" };
...
//rejected
const list<string> NFA_10s_t7 = { "0 1001","2 001","2 01", "empty" };
const list<string> NFA_10s_t8 = { "0 1010","1 1010","empty" };
const list<string> NFA_10s_t9 = { "0 1010","1 010","1 10","2 10","emtpy" };
...
const list<string> NFA_10s_t12 = { "0 EPSILON","1 EPSILON","empty" };
...
const list<string> NFA_empty_string_t10 = { "0 1111","1 111", "empty" };
...
const list<string> NFA_nonempty_string_t11 = { "0 1111","0 0111","1 111","empty" };
const list<string> NFA_nonempty_string_t12 = { "0 1111","0 1110","0 11","1 1","empty" };
...
const list<string> NFA_10_t8 = { "2 1000", "1 000","2 00","empty" };
const list<string> NFA_10_t9 = { "0 11111", "2 1111", "empty" };
const list<string> NFA_10_t10 = { "1 EPSILON" };
const list<string> NFA_10_t11 = { "0 1011", "2 011", "2 11", "empty" };
const list<string> NFA_10_t12 = { "0 10101", "1 0101", "1 101", "empty" };
...
const list<string> NFA_non_empty_even_len_t8 = { "0 0", "2 0", "empty" };
const list<string> NFA_non_empty_even_len_t9 = { "0 1000", "1 1000", "2 00", "1 0", "2 EPSILON" };
const list<string> NFA_non_empty_even_len_t10 = { "0 1000", "3 000", "empty" };
...
//rejected
const list<string> NFA_0s_t8 = { "0 11", "2 1", "empty" };
const list<string> NFA_0s_t9 = { "2 11", "empty" };
const list<string> NFA_0s_t10 = { "0 011", "2 11", "empty" };
const list<string> NFA_0s_t11 = { "0 11", "1 11", "empty" };
...
const list<string> NFA_0s_or_01s_t10 = { "2 1","empty" };
...
const list<string> NFA_1s_or_end_0_t8 = { "1 11","empty"};
